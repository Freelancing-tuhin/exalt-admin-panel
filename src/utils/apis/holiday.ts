...
const initialRoute = "/holiday";

export const createHoliday = async (payload: Payload) => {
  try {
...
export const getAllHoliday = async (params: Params = {}) => {
  try {
    const endpoint = `${initialRoute}/`;
...
export const updateHoliday = async (id: string, payload: Payload) => {
  try {
    const endpoint = `${initialRoute}/${id}`;
