...
const initialRoute = "/brief";

export const createBrief = async (payload: Payload) => {
  try {
...
export const getAllBrief = async (params: Params = {}) => {
  try {
    const endpoint = `${initialRoute}/`;
...
export const updateBrief = async (id: string, payload: Payload) => {
  try {
    const endpoint = `${initialRoute}/${id}`;
...
export const deleteBrief = async (id: string) => {
  try {
    const endpoint = `${initialRoute}/${id}`;
