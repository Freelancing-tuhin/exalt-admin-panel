...
const potentialDonorsData: Donor[] = [
  ...
  },
  {
    ...
    address: "111 Sycamore Sq",
    interests: "Education",
  },
  {
    name: "Isabella Brown",
    email: "isabella.b@example.com",
    address: "222 Redwood Rte",
    interests: "Human Rights",
  },
  {
    name: "Mia Black",
    email: "mia.b@example.com",
    address: "333 Cypress Cr",
    interests: "Community Dev",
  },
  {
    name: "Noah White",
  ...
  },
  {
    ...
    address: "555 Beech Blv",
    interests: "Research",
  },
  {
    name: "Liam Pink",
    email: "liam.p@example.com",
    address: "666 Alder Aly",
  ...
  },
  {
    ...
    address: "1111 Cedar Ave",
    interests: "Environment",
  },
  {
    name: "Evelyn Bronze",
    email: "evelyn.b@example.com",
    address: "1212 Maple Dr",
    interests: "Arts & Culture",
  },
  {
    name: "Abigail Copper",
    email: "abigail.c@example.com",
    address: "1313 Willow Way",
    interests: "Finance",
  },
];
  ...
  JUNE: [
    {
      ...
      date: "06/10/25",
      donorCount: 25,
      donors: potentialDonorsData.slice(0, 25).map((d) => d.name),
    },
    {
      id: "j2",
      title: "XYZ",
      date: "06/10/25",
      donorCount: 100,
      donors: potentialDonorsData.slice(0, 5).map((d) => d.name),
    },
    {
      id: "j3",
      title: "XYZ",
      date: "06/05/25",
      donorCount: 85,
      donors: potentialDonorsData.slice(5, 10).map((d) => d.name),
    },
    {
      id: "j4",
      title: "XYZ",
      date: "05/05/25",
      donorCount: 75,
      donors: potentialDonorsData.slice(10, 15).map((d) => d.name),
    },
  ],
  MAY: [
    {
      ...
      date: "06/10/25",
      donorCount: 96,
      donors: potentialDonorsData.slice(15, 20).map((d) => d.name),
    },
    {
      id: "m2",
      title: "XYZ",
      date: "06/10/25",
      donorCount: 75,
      donors: potentialDonorsData.slice(20, 25).map((d) => d.name),
    },
    {
      id: "m3",
      title: "XYZ",
  ...
  return (
    <Layout>
      <div className="p-4 space-y-8">
        ...
        {/* Donor By Article */}
        <h2 className="bg-gray-200 text-gray-800 font-semibold text-xl px-4 py-2 rounded-t-md pb-0 mb-0 w-1/5">
          Donor By Article
        </h2>
        <section className="bg-gray-200 rounded-b-lg p-6 md:p-8 relative">
          {Object.entries(articlesData).map(([month, articles]) => (
            <div key={month} className="mb-8 last:mb-0">
              <h3 className="text-md font-semibold text-gray-800 mb-4 bg-white px-3 py-1 rounded-md inline-block shadow-sm">
                {month}
              </h3>
              <div className="space-y-3">
                {articles.map((article) => (
                  <div
                    key={article.id}
                    className="grid grid-cols-3 items-center bg-white rounded-lg p-4 shadow-sm border border-gray-200"
                  >
                    {/* Title & Date */}
        ...
        {/* Donor By Interest */}
        <h2 className="bg-gray-200 text-gray-800 font-semibold text-xl px-4 py-2 rounded-lg pb-0 mb-0 w-1/5">
          Donor By Interest
        </h2>
        <section className="bg-gray-200 rounded-b-lg p-6 md:p-8">
          <h3 className="text-md font-semibold text-gray-800 mb-4">
            Donors by Popular Interests
          </h3>
          <div className="flex flex-wrap gap-2 pb-5 mb-5 border-b border-gray-300">
            {popularInterests.map((interest, index) => (
              <button
                key={index}
                className="inline-flex items-center justify-center rounded-full px-4 py-2 text-sm font-medium bg-white text-gray-800 border border-gray-400 hover:bg-gray-100 transition-colors shadow-sm"
              >
          ...
          <div className="mb-6">
            ...
            <input
              ...
              className="w-full p-3 rounded-md border border-gray-300 focus:ring-blue-500 focus:border-blue-500 shadow-sm text-sm bg-white"
            />
            <p className="text-xs text-gray-600 mt-2">
              Things that will show up: Article connected to donors, interest,
              topics not included above, etc.
            </p>
          </div>
        </section>
      </div>
