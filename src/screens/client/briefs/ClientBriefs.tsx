...
const briefsData = [
  ...
  },
  {
    ...
    periods: [
      ...
      {
        dateRange: "April 1 - April 14, 2025",
        articles: 9,
        viralDiscussions: 12,
      },
    ],
                      ...
                      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center p-3 sm:p-4 gap-3">
                        ...
                        <div className="flex items-center gap-2 sm:gap-3 flex-wrap justify-start sm:justify-end mt-2 sm:mt-0 w-full sm:w-auto">
                          ...
                          <span className="flex items-center gap-1 bg-pink-50 text-pink-700 px-2 py-1 rounded-full font-medium text-xs sm:text-sm whitespace-nowrap">
                            ...
                            {period.viralDiscussions} Viral Discussions
                          </span>
                          ...
                          <div className="flex flex-wrap gap-2 sm:gap-3 mt-2 sm:mt-0 w-full sm:w-auto justify-start sm:justify-end">
                            ...
                            >
                              <FiArrowRightCircle className="text-sm sm:text-base" />{" "}
                              View details
                            </Link>
                          </div>
                        </div>
                      ...
                      >
                        <div className="border-t border-gray-200 pt-3 sm:pt-4">
                          ...
                          <p className="text-gray-700 text-xs sm:text-sm leading-relaxed">
                            The U.S. Department of Energy unveiled a $1.2
                            billion initiative to accelerate the development of
                            solid-state batteries, with a focus on bolstering
                            domestic electric vehicle manufacturing and reducing
                            reliance on foreign supply chains. Wildfires in
                            Northern California prompted the largest coordinated
                            drone mapping effort in state history, enabling
                            firefighters to contain over 70% of active blazes
                            within days. The national job market showed
                            resilience, with unemployment holding at 3.8%
                            despite slowing wage growth. Meanwhile, the
                            Smithsonian Institution opened a groundbreaking
                            exhibition on the role of artificial intelligence in
                            shaping American culture, attracting more than
                            50,000 visitors in its first week. On the sports
                            front, the U.S. Men’s Basketball Team announced its
                            Olympic roster, stirring debate after several
                            veteran players were left out in favor of younger
                            talent.
                          </p>
                        </div>
                      </div>
