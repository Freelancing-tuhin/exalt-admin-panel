...
import { FaInstagram, FaFacebook } from "react-icons/fa";
import { FaXTwitter } from "react-icons/fa6";
import { getEventById } from "../../../utils/apis/event";
      ...
      <div className="flex flex-col md:flex-row h-[92vh]">
        ...
        <div className="md:w-5/7 overflow-y-scroll px-6 flex flex-col space-y-6 hidescroll">
          <Header
            ...
            readTime="5 min"
            category={event.tags.map((t) => t.name).join(", ")}
          />
            ...
            <div className="bg-white p-4 rounded-lg space-y-4">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="flex flex-col space-y-1">
                  ...
                  <span className="text-gray-700">{new Date(event.event_date).toLocaleString()}</span>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="flex flex-col space-y-1">
                  ...
                  <span className="text-gray-700 font-medium">{event.location.venue}</span>
                  {event.location.address && <span className="text-gray-600">{event.location.address}</span>}
                  <span className="text-gray-600">
          ...
          {/* Cultural Sensitivities */}
          <div className="bg-gray-100 p-4 rounded-2xl space-y-4">
            <h2 className="text-lg font-semibold text-gray-800">Cultural Sensitivities</h2>
            <ul className="bg-white p-4 rounded-lg list-disc list-inside text-gray-700 text-sm md:text-base space-y-1">
              {event.data.cultural_sensitivities.map((item, idx) => (
                <li key={idx}>{item}</li>
              ))}
            </ul>
          </div>
          ...
          {/* Social Media */}
          <div className="bg-gray-100 p-4 rounded-2xl space-y-4">
            <h2 className="text-lg font-semibold text-gray-800">Social Media Content</h2>

            {event.social_media_content.instagram_facebook && (
              <div className="bg-white p-4 rounded-lg border border-gray-200 hover:border-purple-300 transition-all duration-200">
                <div className="flex items-start space-x-3">
                  <div className="flex space-x-2">
                    <div className="w-8 h-8 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg flex items-center justify-center">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-2">
                      <h3 className="font-medium text-gray-800">Instagram / Facebook</h3>
                      <button
                        onClick={() => copyToClipboard(event.social_media_content.instagram_facebook)}
                        className="p-2 rounded-lg text-gray-500 hover:bg-gray-100 hover:text-gray-700 transition-all"
                        title="Copy content"
                      >
                        <FiCopy size={16} />
            ...
            {event.social_media_content.twitter_x && (
              <div className="bg-white p-4 rounded-lg border border-gray-200 hover:border-blue-300 transition-all duration-200">
                <div className="flex items-start space-x-3">
                  <div className="w-8 h-8 bg-black rounded-lg flex items-center justify-center">
                    <FaXTwitter className="w-5 h-5 text-white" />
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-2">
                      <h3 className="font-medium text-gray-800">X (Twitter)</h3>
                      <button
                        onClick={() => copyToClipboard(event.social_media_content.twitter_x)}
                        className="p-2 rounded-lg text-gray-500 hover:bg-gray-100 hover:text-gray-700 transition-all"
                        title="Copy content"
                      >
                        <FiCopy size={16} />
                    ...
                    <div className="mt-2 text-xs text-gray-500">
                      {event.social_media_content.twitter_x.length} characters
                    </div>
                  </div>
                </div>
              </div>
          ...
          {/* External Resources */}
          {event.external_sources.length > 0 && (
            <div className="bg-gray-100 rounded-2xl p-4 space-y-4">
              <h2 className="text-lg font-semibold text-gray-800">External Resources</h2>
              <div className="overflow-x-auto bg-white rounded-xl">
                <table className="min-w-full table-auto border-separate border-spacing-y-2">
                  <thead>
                    <tr className="text-xs text-gray-500 uppercase font-semibold border-b border-gray-200">
                  ...
                  <tbody>
                    {event.external_sources.map((source, idx) => (
                      <tr key={idx} className="bg-gray-50 hover:bg-gray-100 transition-all">
                        <td className="p-3 text-center">
                          <button
