...
export const DonorOutreach = () => {
  const generalMessages = [
    ...
    },
    {
      type: "Email",
      content:
        "As you are likely aware, India has banned Jane Street for leveraging a legal arbitrage opportunity. I'm aware that this is a topic which is interesting to you, and if you have want to discuss further, you can reply to this email or reach me at [email].",
    },
    {
      type: "Facebook",
      content:
        "Hearing today that India banned an American comapny from their stock exchange. This cannot be allowed. MAGA!!!1!1!!",
    },
  ];
