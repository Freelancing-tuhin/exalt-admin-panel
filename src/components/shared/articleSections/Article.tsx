  ...
  return (
    <div>
      <div className="prose prose-sm max-w-none">
        ...
        <p className="pb-10 text-md leading-loose tracking-wider">
          {data?.[id]?.context}
        </p>
      </div>

      <blockquote className="border-l-4 border-red-400  item-center py-6 pb-5 text-lg mb-10 bg-gray-100 pl-4 italic  text-gray-700">
        “My mother was very proud of her Indian heritage and taught us, me and
        my sister Maya, to share in the pride about our culture. India is the
        largest democracy in the world; so that is part of my background.” —
      ...
      <div className="mb-5 mt-5">
        ...
        <p className="text-md leading-loose tracking-wider">
          ...
          active every year, it's important to connect emotionally with stories
          like these. Consider including this speech link in follow-up messages.
          Also, referencing past Indian-American political wins could be a good
          motivator for further engagement and support.
        </p>
      </div>
